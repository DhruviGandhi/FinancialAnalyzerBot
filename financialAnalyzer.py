...
class FinancialAnalyzer:
    ...
    def _parse_workbook(self) -> Dict[str, Any]:
        ...
        if 'Folio Wise' in xl.sheet_names:
            ...
            for idx, row in df.iterrows():
                ...
                if len(non_na_vals) == 1 and ('patel' in str(non_na_vals[0]).lower()):
                    current_holder = str(non_na_vals[0]).strip()
    ...
    def answer_question(self, query: str) -> str:
        ...
        system_prompt = (
            "You are a Mutual Fund Advisor for clients HARSHESH JAYANTIBHAI PATEL and SONALBEN HARSESH PATEL.\n"
            f"{compact_data}\n\n"
